...
Built for the **Alibaba Cloud AI Hackathon Pakistan 2026** (Grade 1 qualifier, regional technical round) using **Qoder** (Qwen3.8-Max) as the primary agentic build tool.
...
PrepXMentor solves this by ingesting the actual new-syllabus textbooks into a vector store and generating grounded, bilingual explanations and exam-format MCQs on demand — for PKR 799/month.
...
- Past Paper Practice with timed attempts (100-min enforcement, backend + frontend)
- AI Study Chat — persistent, RAG-grounded conversational follow-up
- Tier-gated auth, subject-scoped access, email verification
- Analytics dashboard — per-topic accuracy, streaks, weak-area flags
- Admin tools — bulk MCQ generation, MCQ bank browser, payment audit log
- Safepay payment integration, PKR 799–2,499/month pricing
...
| Mathematics | 24/26 chapters (2 pending) |
| Physics | Ch. 1, 13–21 ingested; Ch. 2–12 in progress |
| English | Not yet started |

## Known Limitations

- Physics chapters 2–12 not yet ingested — actively sourcing
- Chemistry MCQ generation partially complete (Groq daily quota bound)
- English content not yet sourced
- Payment flow verified end-to-end in test environment; production pricing being finalized ahead of Dec 15 launch
...
This project was built using Qoder (Enterprise Plan) pinned to Qwen3.8-Max, including a generated Repo Wiki for codebase navigation. Qoder was used for the majority of feature development during the hackathon build phase.
