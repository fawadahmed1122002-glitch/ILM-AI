    ...
    <div className="max-w-3xl mx-auto px-4 py-6 sm:py-8">
      ...
      {timeCritical && (
        <div className="mb-4 p-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-900 text-red-700 dark:text-red-400 text-sm rounded-xl text-center">
          Less than 5 minutes left — the timer won&apos;t auto-submit, remember to submit manually.
        </div>
      )}
      ...
      <div className="flex gap-3 mb-4">
        ...
        {currentIndex < test.questions.length - 1 ? (
          <button
            onClick={() => goTo(currentIndex + 1)}
            className="flex-1 py-2.5 bg-teal-700 hover:bg-teal-600 dark:bg-teal-600 dark:hover:bg-teal-500 text-white text-sm font-semibold rounded-lg transition-colors"
          >
            Next
          </button>
        ) : (
